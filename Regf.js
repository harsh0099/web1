         ...
         <div className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 bg-gray-200">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="my-2 w-1/2 lg:w-2/4">
                        ...
                        <div
                            className="ref1 w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-blue-900 rounded-2xl">
                            <div className="flex flex-col text-white">
                                
                                <div className="flex my-4 w-2/3 lg:w-3/4">
                                    <div className="flex flex-col">
                                        <i className="fas fa-map-marker-alt pt-2 pr-2 fa-2x " />
                                    </div>
                                    <div className="flex flex-col ml-4">
                                        <h3 className="text-light">Office Address</h3>
                                        <p className="text-gray-400 text-light">Ilo Awela, Ota, Ogun State</p>
                                    </div>
                                </div>
                    ...
                    <div className="flex ">
                        ...
                        <div className="flex flex-col ">
                        <h3 className=" ref4 text-light ml-2">Call Us</h3>
                        <p className="text-gray-400 text-light mr-5">Tel: 08055384406</p>
                        
                            <div className='mt-1 flex'>
                            <i className="reg3 fas fa-envelope pt-2 pr-2 fa-2x mr-1" />
                                <div className='ml-3'> <h3 className="text-light">Send an E-mail</h3>
                                <p className="reg33 text-light-400 ">info@mld.ng</p></div>
                            </div>
