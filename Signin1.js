                ...
                <div class="row justify-content-center my-auto">
                    <div class="col-md-8 col-10 my-5">
                        <div class="row justify-content-center px-3 mb-3">
                            <img id="logo" src={Logo6}/>
                        </div>
                        <h3 class="mb-5 text-center heading">We are ___</h3>

                        <h6 class="msg-info">Please login to your account</h6>

                        <div class="form-group">
                            <label class="form-control-label text-muted">Username</label>
                            <input className='input1' type="text" id="email" name="email" placeholder="Phone no or email id" class="form-control"/>
                        </div>

                        <div class="form-group">
                            <label class="form-control-label text-muted">Password</label>
                            <input className='input1' type="password" id="psw" name="psw" placeholder="Password" class="form-control"/>
                        </div>
